...
const CATALOG = [
  {
    id: "warehouses",
    title: "Warehouses",
    blurb: "Find out possible locations to store your physical goods.",
    mark: "W",
  },
  {
    id: "wholesalers",
    title: "Wholesalers",
    blurb: "Find sources to get your goods from.",
    mark: "W",
  },
  {
    id: "offices",
    title: "Office Spaces",
    blurb: "Organize and track your startup tasks efficiently with meetings.",
    mark: "O",
  },
  {
    id: "transport",
    title: "Transport services",
    blurb: "Deliver your goods from one location to another without delays.",
    mark: "T",
  },
  {
    id: "security",
    title: "Security services",
    blurb: "Make sure your store is secure.",
    mark: "S",
  },
];
...
export default function ResourcesPage() {
  ...
  const onExplore = (id) => {
    // Wire this up to routing when ready
    alert(`Explore: ${id}`);
  };
          ...
          {items.length === 0 ? (
            ...
            items.map((x) => (
              <article key={x.id} className="rs-card">
                <div className="rs-card__mark" aria-hidden>
                  {x.mark}
                </div>
